...
#include <set>
#include <random>
#include <fstream> // Stream class to both read and write from/to files, used for the results
...
class Segment_plus_Set : public State { // с дополнениями
private:
...
class Segment_minus_Set : public State { // с пропусками
private:
    SegmentState segment;
    SetState set;
